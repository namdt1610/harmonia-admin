        ...
        <div className="flex items-center space-x-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 hover:bg-gray-700 rounded-full p-1">
                <Avatar className="h-8 w-8 border border-gray-700">
                  <AvatarImage src="/images/avatar.png" />
                  <AvatarFallback className="bg-spotifyGreen text-black">AD</AvatarFallback>
                </Avatar>
