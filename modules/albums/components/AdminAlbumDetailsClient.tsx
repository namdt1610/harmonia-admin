...
import { Play, Pause, Heart, MoreHorizontal, Clock, Users } from 'lucide-react'
import { useState } from 'react'
import { useQuery } from '@tanstack/react-query'
import { getAlbum } from '@/lib/api/albums'
import { Skeleton } from '@/components/ui/skeleton'

interface AdminAlbumDetailsClientProps {
    id: string
}

export default function AdminAlbumDetailsClient({
    id,
}: AdminAlbumDetailsClientProps) {
    ...
    return (
        <div className="container mx-auto py-6 space-y-6">
            ...
            <Card>
                <CardHeader>
                    <h2 className="text-xl font-semibold">Album Statistics</h2>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-2xl font-bold">
                                {(album.plays * 0.7).toLocaleString()}
                            </p>
                        </div>
                    </div>
                </CardContent>
